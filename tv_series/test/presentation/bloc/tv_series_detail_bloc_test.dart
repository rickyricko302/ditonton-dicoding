...
void main() {
  ...
  blocTest<TVSeriesDetailBloc, TVSeriesDetailState>(
    ...
    build: () {
      ...
      when(
        mockGetRecommendationsTVSeries.execute(tId),
  ...
  blocTest<TVSeriesDetailBloc, TVSeriesDetailState>(
    ...
    build: () {
      when(
        mockWatchlistService.addTvSeriesWatchlist(testTVSeriesDetail),
      ).thenAnswer((_) async => const Right('Added to Watchlist'));
      when(
        mockWatchlistService.loadTvSeriesWatchlistStatus(testTVSeriesDetail.id),
  ...
  blocTest<TVSeriesDetailBloc, TVSeriesDetailState>(
    ...
    build: () {
      when(
        mockWatchlistService.removeTvSeriesWatchlist(testTVSeriesDetail),
