...
//
//     final tvSeriesDetailModel = tvSeriesDetailModelFromJson(jsonString);
...
String tvSeriesDetailModelToJson(TVSeriesDetailModel data) =>
...
class TVSeriesDetailModel extends Equatable {
  ...
  factory TVSeriesDetailModel.fromJson(
  ...
  @override
  List<Object?> get props => [adult, backdropPath, id];
  TVSeriesDetail toEntity() {
    return TVSeriesDetail(
      ...
      genres: genres == null
          ? []
          : genres!.map((genre) => genre.toEntity()).toList(),
      seasons: seasons == null
          ? []
